...
button.addEventListener('click', function(e) {
	Titanium.Platform.openURL('http://www.subsonic.org/');
});
...
buttonShare.addEventListener('click', function(e) {
	...
	intent.putExtra(Ti.Android.EXTRA_TEXT, "Check this cool Application : Android Privacy Guard : http://www.subsonic.org/");

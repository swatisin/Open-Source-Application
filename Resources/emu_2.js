...
for (var i=1; i<=1; i++){
  ...
  var labelDetails = Ti.UI.createLabel({
    ...
    text:'Android Port of RetroArch',
    left:70, top:44,
    width:360
  });
...
button.addEventListener('click', function(e) {
	Titanium.Platform.openURL('https://f-droid.org/repo/org.retroarch_22.apk');
});
...
buttonShare.addEventListener('click', function(e) {
	...
	intent.putExtra(Ti.Android.EXTRA_TEXT, "Check this cool Application : RetroArch : https://f-droid.org/repo/org.retroarch_22.apk");

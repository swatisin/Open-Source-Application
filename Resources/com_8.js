...
for (var i=1; i<=1; i++){
  ...
  var labelDetails = Ti.UI.createLabel({
    ...
    text:'Android client for TorProject.org network',
    left:70, top:44,
    width:360
  });
...
buttonShare.addEventListener('click', function(e) {
	...
	intent.putExtra(Ti.Android.EXTRA_TEXT, "Check this cool Application : Orbot : https://www.torproject.org/docs/android.html.en");
